...
.. table:: **Lagrange Function Spaces by Element Type**
  ...
  |          |         | :math:`N = \frac{(p+1)(p+2)(p+3)}    |                                          | i+j+k \leq p, \min(i,j,k)`               | 
  |          |         | {6}`                                 |                                          | :math:`\geq 2\}`                         |
  |          |         |                                      |                                          |                                          |
  ...
  |          |         | :math:`N = \frac{(p+1)^2(p+2)}{2}`   |                                          | :math:`\mathcal{L}_{p-2}(w))`            |
  |          |         |                                      |                                          |                                          |
  |          |         |                                      |                                          | :math:`N = (p+1)^2(p+2)/2 -`             |
  |          |         |                                      |                                          | :math:`(p-1)^2p/2`                       |
  +----------+---------+--------------------------------------+------------------------------------------+------------------------------------------+
  | Pyramid  | PYRA_5  | :math:`\mathcal{V}_p(u,v,w) =        | n/a                                      | n/a                                      |
  |          |         | \bigoplus_{k=0}^{p}`                 |                                          |                                          |
  |          |         | :math:`\quad \left(                  |                                          |                                          |
  |          |         | \mathcal{Q}_{p-k}(u,v) \otimes       |                                          |                                          |
  |          |         | \mathcal{L}_k(w) \right)`            |                                          |                                          |
  |          |         |                                      |                                          |                                          |
  |          |         | :math:`N = \frac{(p+1)(p+2)          |                                          |                                          |
  |          |         | (2p+3)}{6}`                          |                                          |                                          |
  +----------+---------+--------------------------------------+------------------------------------------+------------------------------------------+
...
**HEXA P=1 (8 nodes) - Node indices by plane**
...
**HEXA P=2 (27 nodes) - Node indices by plane**
